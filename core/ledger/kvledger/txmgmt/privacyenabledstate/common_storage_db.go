...
import (
	...
	"github.com/hyperledger/fabric/core/ledger/kvledger/txmgmt/statedb/statehelium"
...
func NewCommonStorageDBProvider(bookkeeperProvider bookkeeping.Provider, metricsProvider metrics.Provider, healthCheckRegistry ledger.HealthCheckRegistry) (DBProvider, error) {
	...
	} else if ledgerconfig.IsHeliumEnabled() {
		vdbProvider = statehelium.NewVersionedDBProvider()
	} else {
